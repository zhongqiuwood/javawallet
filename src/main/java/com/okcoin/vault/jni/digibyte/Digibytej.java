...
public class Digibytej {
    ...
    public static void main(String[] args)
    {
        try {
            ...
            String[] address = com.okcoin.vault.jni.digibyte.Digibytej.execute(networkType, getaddressbyprivatekey);
            ...
            String[] createResults = com.okcoin.vault.jni.digibyte.Digibytej.execute(networkType, createrawtransaction);
            ...
            String[] signResults = com.okcoin.vault.jni.digibyte.Digibytej.execute(networkType, signrawtransaction);
