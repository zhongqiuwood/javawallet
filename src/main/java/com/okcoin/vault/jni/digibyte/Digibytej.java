...
public class Digibytej {
    ...
    public static void main(String[] args)
    {
        try {
            ...
            com.okcoin.vault.jni.digibyte.Digibytej.dump("getaddressbyprivatekey", address);
            ...
            com.okcoin.vault.jni.digibyte.Digibytej.dump("createrawtransaction", createResults);
            ...
            com.okcoin.vault.jni.digibyte.Digibytej.dump("signrawtransaction", signResults);
